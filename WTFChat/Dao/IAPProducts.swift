...
public class IAPProducts {
    ...
    public static let HINTS_X2 = PREFIX + "HX2"
    ...
    public static let NON_CONSUMABLE: Set<ProductIdentifier> = [
        CIPHER_ALL,
    ...
    public static func resourceNameForProductIdentifier(productIdentifier: String) -> String? {
    ...
    public static func isNonConsumbale(product: ProductIdentifier) -> Bool {
